...
| [`verify-queue`](verify-queue/README.md) | Project verify queue of worktree-dev committed fixes | `ctx.verifyQueue` |
| [`client-ui-verify-queue`](client-ui-verify-queue/README.md) | Right-edge Web drawer for the verify queue | — |
| [`verify-queue-web-profile`](verify-queue-web-profile/README.md) | Source-checkout Web layer for the verify queue | — |
